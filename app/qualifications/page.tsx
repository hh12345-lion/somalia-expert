  ...
  return (
    <>
      ...
      <PageShell title="Somalia Expert Witness Qualifications UK" breadcrumbs={crumbs}>
        <h2 className="text-xl font-bold text-[#0F2420]">What Makes a Qualified Somalia Expert</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0F2420]">Key Qualifications for Somalia Experts</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0F2420]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0F2420]">Red Flags</h2>
        <ul className="mt-4 list-disc space-y-2 pl-6 text-[#3A4542]">
