  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C1F24]">What Somalia Experts Assess</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C1F24]">When to Instruct a Somalia Expert</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C1F24]">Legal Aid: Scotland (SLAB) and England/Wales (LAA)</h2>
        <p className="mt-4 text-[#4A5058] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C1F24]">Report Standards</h2>
        <p className="mt-4 text-[#4A5058] leading-relaxed">
        ...
        <p className="mt-8">
          <Link href="/qualifications" className="font-semibold text-[#7A3048] hover:underline">
