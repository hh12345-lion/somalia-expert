...
const btnPrimary =
  "inline-flex min-h-[44px] w-full items-center justify-center rounded-[8px] bg-[#E07050] px-5 py-2.5 text-sm font-semibold text-white shadow-[0_2px_8px_rgba(224,112,80,0.35)] transition hover:bg-[#C45A3C] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E07050] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0F2420] sm:w-auto";
const btnSecondary =
  "inline-flex min-h-[44px] w-full items-center justify-center rounded-[8px] border border-white/35 bg-white/5 px-5 py-2.5 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/12 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#0F2420] sm:w-auto";
const btnGhost =
...
export function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl overflow-hidden rounded-[8px] border border-[#E07050]/30 bg-[#0F2420] shadow-[0_-4px_40px_rgba(0,0,0,0.28),0_8px_32px_rgba(15,36,32,0.4)]">
        <div className="h-1 bg-gradient-to-r from-[#E07050] via-[#E88A70] to-[#E07050]" aria-hidden />
        <div className="p-5 sm:p-6">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#E07050]">
                Privacy & compliance
              </p>
              ...
              <p id="cookie-banner-desc" className="mt-2 text-sm leading-relaxed text-white/82">
                ...
                <Link href="/cookie-policy" className="font-semibold text-[#E07050] hover:underline">
                  Cookie Policy
                </Link>{" "}
                and{" "}
